...
const ACTION_LABELS = {
  ...
  REFUND_RECONCILED_SUCCESS: 'Đối soát hoàn tiền thành công',
  REFUND_MANUAL_ADJUDICATION_SUCCESS: 'Phân xử thủ công: đã hoàn thành công',
  REFUND_MANUAL_ADJUDICATION_FAILED: 'Phân xử thủ công: lần hoàn thất bại',
  REFUND_NOTIFICATION_DELIVERED: 'Đã giao thông báo hoàn tiền',
...
const METADATA_LABELS = {
  ...
  evidenceNote: 'Bằng chứng đối chiếu',
  gatewayTransactionId: 'Mã hoàn cổng thanh toán',
  paymentTransactionRef: 'Mã thanh toán gốc',
  refundTransactionId: 'Mã giao dịch hoàn nội bộ',
  recoveryCaseId: 'Mã Rescue',
