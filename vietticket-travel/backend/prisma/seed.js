...
async function seedAttractions(partner) {
  ...
  const banaHills = await prisma.attraction.create({
    data: {
      ...
      environment: 'MIXED',
      isFullDay: true,
      meetingPoint: 'Quầy kiểm soát vé tại cổng chính Sun World Ba Na Hills.',
      checkInInstructions: 'Xuất trình mã QR VietTicket còn hiệu lực tại quầy kiểm soát và giấy tờ tùy thân khi được yêu cầu.',
      accessibilityInfo: 'Có khu vực hỗ trợ khách dùng xe lăn; vui lòng xác nhận trước với điểm tham quan về từng hạng mục trải nghiệm.',
        ...
        create: [
          {
            ...
            inclusions: ['Quyền vào cửa theo điều kiện của gói vé người lớn'],
            exclusions: ['Đồ ăn, thức uống và chi phí cá nhân'],
          ...
          },
          {
            ...
            inclusions: ['Quyền vào cửa theo điều kiện của gói vé trẻ em'],
            exclusions: ['Đồ ăn, thức uống và chi phí cá nhân'],
