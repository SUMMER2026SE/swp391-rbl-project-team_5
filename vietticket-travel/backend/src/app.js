...
app.use(express.json({
  ...
  verify(req, _res, buffer) {
    // SePay signs the exact bytes it sends. Preserve those bytes before JSON
    // parsing so HMAC verification cannot be broken by re-serialization.
    if (req.originalUrl?.startsWith('/api/payments/sepay/webhook')) {
