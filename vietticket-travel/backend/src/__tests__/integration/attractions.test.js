...
describe('GET /api/attractions/:id', () => {
  test('✅ Trả 200 khi tìm thấy', async () => {
    mockPrisma.attraction.findUnique.mockResolvedValue({ id: 'attr-001', title: 'Test', status: 'APPROVED', publicationStatus: 'ACTIVE', operationalStatus: 'ACTIVE', publishedAt: new Date('2026-06-01T00:00:00.000Z'), archivedAt: null, partner: { status: 'APPROVED' }, images: [], categories: [], ticketProducts: [] });
