...
describe('getAttractionDetail', () => {
  test('✅ Trả về chi tiết nếu tìm thấy và status APPROVED', async () => {
    mockPrisma.attraction.findUnique.mockResolvedValue({ id: 'attr-001', title: 'Suối Tiên', status: 'APPROVED', publicationStatus: 'ACTIVE', operationalStatus: 'ACTIVE', publishedAt: new Date('2026-06-01T00:00:00.000Z'), archivedAt: null, partner: { status: 'APPROVED' }, images: [], categories: [], ticketProducts: [] });
