...
describe('reviewAttraction', () => {
  test('✅ APPROVED cập nhật trạng thái APPROVED', async () => {
    const submittedData = {
      ...
      tickets: [{ id: 't-1', name: 'Vé', type: 'ADULT', admissionCount: 1, inclusions: ['Vé vào cổng'], exclusions: [], originalPrice: 100, sellingPrice: 80, status: 'ACTIVE', refundPolicy: 'NON_REFUNDABLE', refundFeeRate: 0 }],
      schedule: {
  ...
  test('keeps a previously paused attraction paused after approving an edited revision', async () => {
    const submittedData = {
      ...
      latitude: 10.8,
      longitude: 106.7,
      meetingPoint: 'Quay ve tai cong chinh',
      checkInInstructions: 'Xuat trinh ma QR tai quay kiem soat truoc khi vao cong.',
      accessibilityInfo: 'Co loi di ho tro xe lan.',
      whatToBring: [],
      category: { id: 'cat-1', name: 'Cong vien' },
      images: [{ id: 'img-1', url: '/a.jpg', isPrimary: true }],
      tickets: [{ id: 't-1', name: 'Ve', type: 'ADULT', admissionCount: 1, inclusions: ['Ve vao cong'], exclusions: [], originalPrice: 100, sellingPrice: 80, status: 'ACTIVE', refundPolicy: 'NON_REFUNDABLE', refundFeeRate: 0 }],
      schedule: {
        openDays: [true, true, true, true, true, true, true],
        defaultCapacity: 100,
        timeSlots: [{ id: 's-1', start: '08:00', end: '17:00', capacity: 100, isActive: true }],
